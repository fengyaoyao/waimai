...
$app->routeMiddleware([
    ...
    'check_shop' => App\Http\Middleware\CheckShop::class,
    'check_delivery' => App\Http\Middleware\CheckDelivery::class,
    'server_ip_auth' => App\Http\Middleware\ServerIpAuthentication::class,
]);//新增
